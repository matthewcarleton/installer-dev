...
[class^="pf-"]::after {
  ...
  line-height: $pf-global--LineHeight--md;
...
@if $pf-global--enable-reset {
  ...
  *::after {
  ...
  body {
    ...
    font-weight: $pf-global--FontWeight--normal;
    line-height: $pf-global--LineHeight--md;
    color: $pf-global--Color--dark-100;
    text-align: left;
    background-color: $pf-global--BackgroundColor--light-100;
  }
  ...
  a {
    ...
    text-decoration: $pf-global--link--TextDecoration;

    &:hover {
      color: $pf-global--link--Color--hover;
      text-decoration: $pf-global--link--TextDecoration--hover;
    }
  }
