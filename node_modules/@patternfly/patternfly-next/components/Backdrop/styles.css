...
:root {
  ...
  --pf-global--BackgroundColor--dark-100: #292e34;
  --pf-global--BackgroundColor--dark-200: #393f44;
  --pf-global--Color--100: #292e34;
  --pf-global--Color--200: #72767b;
  --pf-global--Color--light-100: #fff;
  --pf-global--Color--light-200: #ededed;
  --pf-global--Color--dark-100: #292e34;
  --pf-global--Color--dark-200: #72767b;
  --pf-global--Color--active: #007bba;
  --pf-global--BackgroundColor--active: #bee1f4;
  --pf-global--BorderColor--active: #007bba;
  --pf-global--Color--disabled: #72767b;
  --pf-global--BackgroundColor--disabled: #d1d1d1;
  --pf-global--BorderColor--disabled: #d1d1d1;
  --pf-global--primary-color--100: #007bba;
  --pf-global--primary-color--200: #00659c;
  --pf-global--secondary-color--100: #72767b;
  --pf-global--success-color--100: #92d400;
  --pf-global--success-color--200: #486b00;
  --pf-global--info-color--100: #39a5dc;
  --pf-global--info-color--200: #004368;
  --pf-global--warning-color--100: #f0ab00;
  --pf-global--warning-color--200: #795600;
  --pf-global--danger-color--100: #c00;
  ...
  --pf-global--BoxShadow: 0 0.125rem 0.0625rem 0.0625rem rgba(3, 3, 3, 0.12), 0 0.25rem 0.6875rem 0.375rem rgba(3, 3, 3, 0.05);
  ...
  --pf-global--BoxShadow-right: 0.3125rem 0 0.625rem -0.25rem rgba(3, 3, 3, 0.25);
  --pf-global--BoxShadow-left: -0.3125rem 0 0.625rem -0.25rem rgba(3, 3, 3, 0.25);
  --pf-global--BoxShadow-bottom: 0 0.3125rem 0.625rem -0.25rem rgba(3, 3, 3, 0.25);
  --pf-global--BoxShadow-top: 0 -0.3125rem 0.625rem -0.25rem rgba(3, 3, 3, 0.25);
  ...
  --pf-global--link--Color: #007bba;
  --pf-global--link--TextDecoration: none;
  --pf-global--link--Color--hover: #00486e;
  ...
  --global-ListStyle: disc outside; }

/* stylelint-enable */
.pf-c-backdrop {
  --pf-c-backdrop--ZIndex: var(--pf-global--ZIndex--xl);
  --pf-c-backdrop--Color: rgba(0, 0, 0, 0.42);
